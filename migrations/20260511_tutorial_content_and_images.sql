DELETE FROM cms_tutorials WHERE slug = 'klaro-kurz-kennenlernen';

ALTER TABLE cms_tutorials
ADD COLUMN IF NOT EXISTS subtitle JSONB NOT NULL DEFAULT '{}'::jsonb;

INSERT INTO cms_tutorials (id, slug, sort_order, title, content, subtitle)
VALUES (
  'c8f4a2b1-9e3d-4c7f-a8b6-2d1e0f9c8b7a',
  'was-ist-grundsicherung',
  10,
  '{"de": "Was ist Grundsicherung?", "en": "What is basic income?"}'::jsonb,
  $$[
    {
      "step_id": "step-1",
      "content": {
  ...
  '{"de": "Hier findest Du die wichtigsten Infos.", "en": "Here you''ll find the key information."}'::jsonb
)
